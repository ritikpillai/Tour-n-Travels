...
function Home() {
  ...
  const checkIndex = (idx) => {
    if (idx < 0) return data.length - 1;
    else if (idx > data.length - 1) return 0;
    else return idx;
  };
  ...
  return (
    <>
      <div
        className="home-page"
        style={{ background: `url(${data[checkIndex(index)].bg})` }}
      >
        <Navbar />
        ...
        <div className="index">
          {data.map((item, i) => {
            ...
            if (i === index) className = "para active";
            else className = "para";
        ...
        <div className="img-carousel">
          {data.map((item, i) => {
            ...
            if (i === index) className = "card card-active";
            else if (i === indexRight) className = "card card-right";
            else if (i === indexRight2) className = "card card-right2";
            else if (i === indexLeft) className = "card card-left";
            else className = "card";
